                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="qty d-flex pt-2">
                            <div class="d-flex font-rale w-25">
                                ...
                                <input id="quantity" type="text" data-id="<?php echo $item['item_id'] ?? '0'; ?>" class="qty_input border px-2 w-100 bg-light" disabled value="1" placeholder="1">
...
// Get the subtotal value from your PHP variable
var subtotal = <?php echo isset($subTotal) ? $Cart->getSum($subTotal) : 0; ?>;
